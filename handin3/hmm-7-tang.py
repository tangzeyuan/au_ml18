...
def test_train():
    ...
    #fname_list = ['genome1.fa', 'genome2.fa']
    fname_list = ['genome{}.fa'.format(i) for i in range(1, 6)]
    #true_list = ['true-ann1.fa', 'true-ann2.fa']
    true_list = ['true-ann{}.fa'.format(i) for i in range(1, 6)]
    ...
    hmm_7_states.save_hmm('hmm-7-counting-1.npz')
...
def test_write_ann():
    ...
    fname_list = ['genome{}.fa'.format(i) for i in range(1, 6)]
    pred_list = ['pred-ann{}.fa'.format(i) for i in range(1, 6)]
